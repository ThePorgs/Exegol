...
function bat() {
  ...
  fapt -f ./bat_0.18.1_amd64.deb
  rm bat_0.18.1_amd64.deb
}

function mdcat() {
  colorecho "Installing mdcat"
  wget https://github.com/lunaryorn/mdcat/releases/download/mdcat-0.22.4/mdcat-0.22.4-x86_64-unknown-linux-musl.tar.gz
  tar xvfz mdcat-0.22.4-x86_64-unknown-linux-musl.tar.gz
  mv mdcat-0.22.4-x86_64-unknown-linux-musl/mdcat /opt/tools/bin
  rm -r mdcat-0.22.4-x86_64-unknown-linux-musl.tar.gz mdcat-0.22.4-x86_64-unknown-linux-musl
